...
const NEON: Record<string, { hex: string; glow: string; text: string }> = {
  blue:   { hex: "#4f8cd9", glow: "rgba(79,140,217,0.45)",  text: "#b7d1f4" },
  cyan:   { hex: "#28c9d6", glow: "rgba(40,201,214,0.45)",  text: "#a8ecf3" },
  green:  { hex: "#8e7cdc", glow: "rgba(142,124,220,0.45)", text: "#c8bff0" },
  gold:   { hex: "#ffd83a", glow: "rgba(255,216,58,0.50)",  text: "#ffe98a" },
  orange: { hex: "#ff6a1f", glow: "rgba(255,106,31,0.50)",  text: "#ffb38a" },
  /* legacy alias — second cyan slot kept for compile compatibility */
  cyan2:  { hex: "#28c9d6", glow: "rgba(40,201,214,0.45)",  text: "#bff3f8" },
  pink:   { hex: "#e6519c", glow: "rgba(230,81,156,0.50)",  text: "#f5a8cc" },
  red:    { hex: "#ff8a1f", glow: "rgba(255,138,31,0.50)",  text: "#ffc59a" },
  teal:   { hex: "#28c9d6", glow: "rgba(40,201,214,0.40)",  text: "#9be6ee" },
  lime:   { hex: "#ffb020", glow: "rgba(255,176,32,0.50)",  text: "#ffd28a" },
  violet: { hex: "#b066d6", glow: "rgba(176,102,214,0.50)", text: "#dcb4ee" },
};
...
const URGENCY_LABEL: Record<UrgencyBand, { en: string; af: string; color: string; glow: string }> = {
  build:   { en: "Build Mastery",      af: "Bou Vaardigheid",     color: "#8e7cdc", glow: "rgba(142,124,220,0.55)" },
  focused: { en: "Focused Revision",   af: "Gefokusde Herhaling", color: "#ffd83a", glow: "rgba(255,216,58,0.55)"  },
  prep:    { en: "Exam Prep Mode",     af: "Eksamenvoorbereiding",color: "#ff8a1f", glow: "rgba(255,138,31,0.55)"  },
  sprint:  { en: "Final Sprint",       af: "Finale Sprint",       color: "#e6519c", glow: "rgba(230,81,156,0.55)"  },
};
...
function SpaceBg() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" style={{ background: "#000000" }}>
      <div style={{ position:"absolute",inset:0, background:"radial-gradient(ellipse 80% 60% at 50% -10%, rgba(40,201,214,0.22) 0%, transparent 70%)" }} />
      <div style={{ position:"absolute",inset:0, background:"radial-gradient(ellipse 55% 45% at 85% 85%, rgba(176,102,214,0.14) 0%, transparent 60%)" }} />
      <div style={{ position:"absolute",inset:0, background:"radial-gradient(ellipse 45% 35% at 15% 90%, rgba(230,81,156,0.10) 0%, transparent 60%)" }} />
      <div style={{ position:"absolute",inset:0, background:"radial-gradient(ellipse 40% 30% at 20% 10%, rgba(255,138,31,0.08) 0%, transparent 60%)" }} />
    ...
    <div className="min-h-screen overflow-x-hidden" style={{ color:"#ffffff" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 gap-4">
            <div className="flex items-center gap-2">
              <CalendarDays className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 4px #28c9d6)" }} />
      ...
      {todayDirective && todayDirective.hasExam && (() => {
        const urgencyMap: Record<string, { color: string; glow: string }> = {
          final_sprint:     { color: "#e6519c", glow: "rgba(230,81,156,0.55)" },
          exam_prep_mode:   { color: "#ff8a1f", glow: "rgba(255,138,31,0.55)" },
          focused_revision: { color: "#ffd83a", glow: "rgba(255,216,58,0.55)" },
          build_mastery:    { color: "#8e7cdc", glow: "rgba(142,124,220,0.55)" },
        };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-5">
        ...
        <section className="relative overflow-hidden">
          ...
          <div
            ...
            style={{ background: "radial-gradient(circle, rgba(176,102,214,0.18), transparent 70%)" }}
          />
          <div className="relative text-center py-10 sm:py-14">
            ...
            >
              <CalendarDays className="w-3.5 h-3.5" style={{ color: "#28c9d6" }} />
              ...
              <div>
                ...
                <p
                  ...
                  style={{
                    ...
                    backgroundImage: "linear-gradient(90deg,#28c9d6,#8e7cdc,#e6519c)",
              ...
              <div className="text-center">
                <p
                  ...
                  style={{
                    ...
                    backgroundImage: "linear-gradient(180deg,#ffffff 0%,#ffd83a 45%,#ff8a1f 100%)",
                    WebkitBackgroundClip: "text", backgroundClip: "text",
                    color: "transparent", WebkitTextFillColor: "transparent",
        ...
        <Link href="/prelim-timetable">
          <div
            ...
            style={{
              background: "rgba(40,201,214,0.07)",
              border: "1px solid rgba(40,201,214,0.35)",
              boxShadow: "0 0 16px rgba(40,201,214,0.10)",
            }}
          >
            <div className="flex items-center gap-3">
              <CalendarDays className="w-5 h-5 shrink-0" style={{ color: "#28c9d6" }} />
              <div>
                <p className="text-sm font-black" style={{ color: "#28c9d6" }}>
            ...
            <ChevronRight className="w-4 h-4 shrink-0" style={{ color: "rgba(40,201,214,0.6)" }} />
          </div>
        </Link>
        ...
        {(() => {
          ...
          return (
            <div data-testid="study-calendar-readiness">
              <GlassCard neonColor="#b066d6" className="overflow-hidden">
                <div
                  className="px-5 py-4 flex items-center gap-2 flex-wrap"
                  style={{ borderBottom: "1px solid rgba(255,255,255,0.06)", background: "rgba(176,102,214,0.06)" }}
                >
                  <ShieldCheck className="w-4 h-4" style={{ color: "#b066d6", filter: "drop-shadow(0 0 6px rgba(176,102,214,0.65))" }} />
                ...
                <div className="p-5 space-y-2.5">
                  {entries.map((e, i) => {
                    ...
                    const bandHex = band === "green" ? "#28c9d6" : band === "amber" ? "#ffd83a" : "#e6519c";
                    return (
                      <div
                        key={e.subjectId}
        ...
        {examScheduleData?.schedule && examScheduleData.schedule.length > 0 && (() => {
          ...
          return (
            <div data-testid="exam-overlay-section">
              <GlassCard neonColor="#8e7cdc" className="overflow-hidden">
                <div className="px-5 py-4 flex items-center gap-2" style={{ borderBottom:"1px solid rgba(255,255,255,0.06)", background:"rgba(142,124,220,0.06)" }}>
                  <GraduationCap className="w-4 h-4" style={{ color:"#8e7cdc", filter:"drop-shadow(0 0 6px rgba(142,124,220,0.65))" }} />
                  <p className="font-bold text-sm" style={{ color:"#ffffff" }}>
                    {isAf ? "NSC Eksamenrooster Oorleg" : "NSC Exam Calendar Overlay"}
                  </p>
                  <span className="ml-auto text-[10px] font-bold px-2 py-0.5 rounded-full" style={{ background:"rgba(142,124,220,0.18)", color:"#dcb4ee", border:"1px solid rgba(142,124,220,0.45)" }}>
                    2026
                  </span>
                </div>
                <div className="p-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 mb-4">
                    {upcoming.slice(0, 9).map((exam: any, i: number) => {
                      const urgencyMap: Record<string, { color: string; glow: string }> = {
                        final_sprint:     { color: "#e6519c", glow: "rgba(230,81,156,0.50)" },
                        exam_prep_mode:   { color: "#ff8a1f", glow: "rgba(255,138,31,0.50)" },
                        focused_revision: { color: "#ffd83a", glow: "rgba(255,216,58,0.50)" },
                        build_mastery:    { color: "#8e7cdc", glow: "rgba(142,124,220,0.50)" },
                      };
                  ...
                  <div className="pt-3" style={{ borderTop:"1px solid rgba(255,255,255,0.06)" }}>
                    <p className="text-[10px] font-bold uppercase mb-2 flex items-center gap-1.5" style={{ color:"#ffffff", letterSpacing:"0.08em" }}>
                      <Coffee className="w-3 h-3" style={{ color:"#ffd83a" }} />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {nonExamDays.map(d => (
                        <span
                          ...
                          style={{ background:"rgba(255,216,58,0.10)", border:"1px solid rgba(255,216,58,0.40)", color:"#ffe98a", boxShadow:"0 0 8px rgba(255,216,58,0.18)" }}
                        >
        ...
        <div>
          <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1" style={{ scrollbarWidth:"none" }}>
            {weekPlan.length === 0 ? (
              subjectsLoading
                ? [0,1,2,3,4,5,6].map(i => (
                    <div key={i} className="flex-shrink-0 w-14 h-10 rounded-xl animate-pulse" style={{ background:"rgba(40,201,214,0.08)", border:"1px solid rgba(40,201,214,0.15)" }} />
                  ))
                : (
              ...
              return (
                <button
                  ...
                  style={isActive
                    ? { border:"1.5px solid #28c9d6", boxShadow:"0 0 14px rgba(40,201,214,0.45), inset 0 0 10px rgba(40,201,214,0.12)" }
                    : { border:"1px solid rgba(255,255,255,0.10)" }}
                  data-testid={`mobile-day-tab-${idx}`}
                >
                  <span
                    className="uppercase tracking-[0.18em]"
                    style={{ fontSize:"10px", fontWeight:800, color:isActive?"#28c9d6":"rgba(255,255,255,0.55)", textShadow: isActive ? "0 0 6px #28c9d6" : undefined }}
                  >
                    {isAf ? day.shortAf : day.short}
                  </span>
                  {isToday && (
                    <span style={{ width:5, height:5, borderRadius:"50%", background:"#28c9d6", marginTop:3, display:"block", boxShadow:"0 0 6px #28c9d6" }} />
                  )}
                </button>
              );
            })}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mb-2 text-center">
                      <p style={{ fontSize:"10px", fontWeight:700, color:isToday?"#28c9d6":"#ffffff", letterSpacing:"0.06em" }}>
                        {isAf ? day.shortAf : day.short}
                      </p>
            ...
            <div data-testid="mobile-day-view">
              {weekPlan.length === 0 && subjectsLoading ? (
                <div className="space-y-3" data-testid="day-view-skeleton">
                  <div className="h-6 w-32 rounded-lg animate-pulse" style={{ background:"rgba(40,201,214,0.08)" }} />
                  {[0,1,2].map(i => (
                    <div key={i} className="h-20 rounded-2xl animate-pulse" style={{ background:"rgba(40,201,214,0.06)", border:"1px solid rgba(40,201,214,0.12)" }} />
                  ))}
                </div>
              ) : weekPlan.length === 0 ? (
                <div className="rounded-2xl bg-black p-8 text-center" style={{ border:"1px solid rgba(255,255,255,0.1)" }} data-testid="day-view-empty">
                  <CalendarDays className="w-10 h-10 mx-auto mb-3" style={{ color:"rgba(40,201,214,0.4)" }} />
                  ...
                  <Link href="/settings">
                    <button className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-[0.16em] bg-black" style={{ color:"#28c9d6", border:"1.5px solid #28c9d6", boxShadow:"0 0 12px rgba(40,201,214,0.35)" }}>
                      <Settings className="w-3 h-3" />
                ...
                return (
                  <GlassCard neonColor={isToday ? "#28c9d6" : undefined} className="p-5">
                      ...
                      <>
                        ...
                        {(() => {
                          ...
                          const theme = hasExamToday
                            ? { label: isAf ? "Eksamendag — Hersiening" : "Exam day — Revision focus", hex: "#ff6a1f", emoji: "🎯" }
                            : load >= 3
                            ? { label: isAf ? "Hoë intensiteit" : "High-intensity block", hex: "#e6519c", emoji: "⚡" }
                            : load === 2
                            ? { label: isAf ? "Gebalanseerde dag" : "Balanced day", hex: "#28c9d6", emoji: "⚖" }
                            : { label: isAf ? "Ligte dag" : "Light day", hex: "#b066d6", emoji: "🌙" };
          ...
          <div className="space-y-4 min-w-0 lg:sticky lg:top-[112px] lg:self-start lg:max-h-[calc(100vh-120px)] lg:overflow-y-auto">
            ...
            <GlassCard className="overflow-hidden">
              <div className="px-5 py-4" style={{ borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
                <div className="flex items-center gap-2">
                  <AlertTriangle className="w-4 h-4" style={{ color:"#ff8a1f" }} />
                  <p className="font-bold text-sm" style={{ color:"#ffffff" }}>
