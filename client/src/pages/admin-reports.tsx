...
function TrialCountdown({ expiryDate }: { expiryDate?: string | null }) {
  ...
  const hex =
    expired ? "#e6519c" :
    totalHoursLeft <= 24 ? "#ff6a1f" :
    totalHoursLeft <= 24 * 7 ? "#ffd83a" :
    totalHoursLeft <= 24 * 30 ? "#28c9d6" :
    "#8e7cdc";
      ...
      {step === 2 && (
        <div className="space-y-3">
          ...
          {parseInt(form.expectedLearnerCount || "0") > 0 && (
            <div className="p-3 rounded-xl bg-black flex items-center justify-between gap-3" style={{ border: "1px solid rgba(255,216,58,0.3)" }}>
              <div className="flex items-center gap-2">
                <DollarSign className="w-4 h-4 shrink-0" style={{ color: "#ffd83a" }} />
                <span className="text-[11px] font-bold uppercase tracking-[0.12em]" style={{ color: "#ffd83a" }}>{isAf ? "Waardeprojeksie" : "Value Projection"}</span>
              </div>
              <div className="text-right">
                <div className="text-xl font-black" style={{ color: "#ffd83a" }}>R{formatNumber((parseInt(form.expectedLearnerCount || "0") || 0) * 35, language)}<span className="text-xs font-semibold text-white/60">/{isAf ? "mo" : "mo"}</span></div>
        ...
        <div className="flex gap-2">
          ...
          {step < ONBOARD_STEPS.length - 1 ? (
            <button
              ...
              style={{ background: `linear-gradient(90deg,${A},#4f8cd9)`, color: "#000", boxShadow: `0 0 18px ${A}55` }}
            >
              {isAf ? "Volgende" : "Next"} →
            </button>
          ) : (
    ...
    <div className="min-h-screen bg-black text-white" style={{ fontFamily: "Sora, ui-sans-serif, system-ui, sans-serif" }}>
      ...
      <div className="p-4 md:p-6 space-y-6 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
            <GlowStatCard label={language === "af" ? "👥 Totale Gebruikers" : "👥 Total Users"} value={stats?.totalUsers ?? 0} icon={Users} accent="primary" />
            <GlowStatCard label={language === "af" ? "🎓 Leerders" : "🎓 Learners"} value={stats?.learners ?? 0} icon={UserCheck} accent="blue" />
            <GlowStatCard label={language === "af" ? "👪 Ouers" : "👪 Parents"} value={stats?.parents ?? 0} icon={Users} accent="cyan" />
            <GlowStatCard label={language === "af" ? "⚡ Aktief Vandag" : "⚡ Active Today"} value={stats?.activeToday ?? 0} icon={TrendingUp} accent="green" />
            <GlowStatCard label={language === "af" ? "🔓 Op Proeflopie" : "🔓 On Trial"} value={stats?.trialUsers ?? 0} icon={Clock} accent="amber" />
            <GlowStatCard label={language === "af" ? "💰 Ingeteken" : "💰 Subscribed"} value={stats?.subscribedUsers ?? 0} sub={language === "af" ? "R169/maand" : "R169/month"} icon={DollarSign} accent="cyan" />
          </div>

          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="mb-5 p-1.5 rounded-2xl h-auto flex-wrap bg-black border border-[#28c9d6]/30 shadow-[0_0_14px_rgba(40,201,214,0.18)]">
              <TabsTrigger value="overview" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <BarChart3 className="w-3.5 h-3.5" /> {language === "af" ? "Oorsig" : "Overview"}
              </TabsTrigger>
              <TabsTrigger value="learners" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <GraduationCap className="w-3.5 h-3.5" /> {language === "af" ? "Leerders" : "Learners"}
              </TabsTrigger>
              <TabsTrigger value="parents" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <Users className="w-3.5 h-3.5" /> {language === "af" ? "Ouers" : "Parents"}
              </TabsTrigger>
              <TabsTrigger value="schools" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <School className="w-3.5 h-3.5" /> {language === "af" ? "Skole" : "Schools"}
              </TabsTrigger>
              <TabsTrigger value="partners" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <Handshake className="w-3.5 h-3.5" /> {language === "af" ? "Vennote" : "Partners"}
              </TabsTrigger>
              <TabsTrigger value="clicks" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <MousePointerClick className="w-3.5 h-3.5" /> {language === "af" ? "Klikke & Proeflopies" : "Clicks & Trials"}
              </TabsTrigger>
              <TabsTrigger value="exam-pressure" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors" data-testid="tab-exam-pressure">
                <Calendar className="w-3.5 h-3.5" /> {language === "af" ? "Eksamendruk" : "Exam Pressure"}
              </TabsTrigger>
              <TabsTrigger value="gamification" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <Zap className="w-3.5 h-3.5" /> {language === "af" ? "Spelifisering" : "Gamification"}
              </TabsTrigger>
              <TabsTrigger value="reminders" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
                <Bell className="w-3.5 h-3.5" /> {language === "af" ? "Herinneringe" : "Reminders"}
              </TabsTrigger>
              <TabsTrigger value="focus-push" className="rounded-xl text-xs gap-1.5 px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#28c9d6] data-[state=active]:border data-[state=active]:border-[#28c9d6] data-[state=active]:shadow-[0_0_14px_rgba(40,201,214,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors">
            ...
            <TabsContent value="overview">
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card className="rounded-2xl border-white/15">
                    <CardHeader className="pb-2"><CardTitle className="text-sm flex items-center gap-2"><PieChart className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} /> {language === "af" ? "Gebruikeruitsplitsing" : "User Breakdown"}</CardTitle></CardHeader>
                    <CardContent className="p-6 pt-2">
                      <DonutChart learners={stats?.learners ?? 0} parents={stats?.parents ?? 0} admins={stats?.admins ?? 0} />
                    </CardContent>
                  </Card>
                  <Card className="rounded-2xl border-white/15">
                    <CardHeader className="pb-2"><CardTitle className="text-sm flex items-center gap-2"><Zap className="w-4 h-4" style={{ color: "#ffd83a", filter: "drop-shadow(0 0 6px #ffd83a)" }} /> {language === "af" ? "Sleutel-insigte" : "Key Insights"}</CardTitle></CardHeader>
                    <CardContent className="p-6 pt-2 space-y-3">
            ...
            <TabsContent value="learners">
              <Card className="bg-black border-white/15 rounded-2xl">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm flex items-center gap-2"><GraduationCap className="w-4 h-4" style={{ color: "#4f8cd9", filter: "drop-shadow(0 0 6px #4f8cd9)" }} /> {language === "af" ? "Leerderbestuur" : "Learner Management"}</CardTitle>
                </CardHeader>
                <CardContent>
                  {/* Filters */}
                  <div className="flex flex-wrap gap-2 mb-4">
                    <div className="relative flex-1 min-w-48">
                      ...
                      <Input placeholder={language === "af" ? "Soek volgens naam, e-pos…" : "Search by name, email…"} className="pl-9 h-9 text-sm rounded-xl" value={learnerSearch} onChange={e => setLearnerSearch(e.target.value)} />
                    </div>
                          ...
                          filteredLearners.map((l: any, i: number) => {
                            ...
                            return (
                              <TableRow key={l.id || i} className={`hover:bg-white/[0.04] even:bg-white/[0.02] ${isSelected ? "bg-white/[0.04]" : ""}`}>
                                ...
                                <TableCell className="text-sm">{l.grade ? (language === "af" ? `Gr ${l.grade}` : `Gr ${l.grade}`) : "—"}</TableCell>
            ...
            <TabsContent value="parents">
              <Card className="bg-black border-white/15 rounded-2xl">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm flex items-center gap-2"><Users className="w-4 h-4" style={{ color: "#b066d6", filter: "drop-shadow(0 0 6px #b066d6)" }} /> {language === "af" ? "Ouerrekeninge" : "Parent Accounts"}</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="schools">
              <div className="flex gap-5">
                ...
                <div className="flex-1 min-w-0 space-y-4">
                  ...
                  <Card className="bg-black border-white/15 rounded-2xl">
                    <CardHeader className="pb-3">
                      <CardTitle className="text-sm flex items-center gap-2"><School className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} /> {language === "af" ? "Skoolbedrywighede" : "School Operations"}</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="overflow-x-auto rounded-xl border border-white/15">
                        <Table>
            ...
            <TabsContent value="partners">
              ...
              <Card className="bg-black border-white/15 rounded-2xl">
                <CardHeader className="pb-3"><CardTitle className="text-sm flex items-center gap-2"><Handshake className="w-4 h-4" style={{ color: "#ff8a1f", filter: "drop-shadow(0 0 6px #ff8a1f)" }} /> {language === "af" ? "Vennoot-verwysings & Kommissie" : "Partner Referrals & Commission"}</CardTitle></CardHeader>
                <CardContent>
                  <div className="overflow-x-auto rounded-xl border border-white/15">
                    <Table>
                      <TableHeader>
            ...
            <TabsContent value="clicks">
              ...
              <Card className="bg-black border-white/15 rounded-2xl">
                <CardHeader className="pb-3"><CardTitle className="text-sm flex items-center gap-2"><MousePointerClick className="w-4 h-4" style={{ color: "#e6519c", filter: "drop-shadow(0 0 6px #e6519c)" }} /> {language === "af" ? "Vennootskakel-klikke & Proeflopie-toeskrywing" : "Partner Link Clicks & Trial Attribution"}</CardTitle></CardHeader>
                <CardContent>
                  <div className="overflow-x-auto rounded-xl border border-white/15">
                    <Table>
                      <TableHeader>
      ...
      <Dialog open={showOnboarding} onOpenChange={setShowOnboarding}>
        <DialogContent
          ...
          style={{ border: "1px solid rgba(40,201,214,0.6)", boxShadow: "0 18px 50px -22px rgba(40,201,214,0.5)" }}
        >
          <DialogHeader className="pb-3 mb-3" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            <DialogTitle className="flex items-center gap-2.5 text-base font-black tracking-tight">
              <span
                ...
                style={{ border: "1px solid #28c9d6", boxShadow: "0 0 8px rgba(40,201,214,0.4)" }}
              >
                <School className="w-3.5 h-3.5" style={{ color: "#28c9d6" }} />
              </span>
        ...
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <School className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} /> {language === "af" ? "Massa-invoer Skole" : "Bulk Import Schools"}
            </DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={showAddPartner} onOpenChange={setShowAddPartner}>
        <DialogContent
          ...
          style={{ border: "1.5px solid #ff8a1f", boxShadow: "0 0 0 1px rgba(255,138,31,0.3), 0 0 32px rgba(255,138,31,0.35), inset 0 0 24px rgba(0,0,0,0.6)" }}
        >
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-base font-black tracking-tight">
              <span
                ...
                style={{ border: "1.5px solid #ff8a1f", boxShadow: "0 0 12px rgba(255,138,31,0.5)" }}
              >
                <Handshake className="w-4 h-4" style={{ color: "#ff8a1f", filter: "drop-shadow(0 0 4px #ff8a1f)" }} />
              </span>
              <span
                style={{
          ...
          {(() => {
            ...
            const fieldStyle = (ok: boolean) => ({
              border: ok ? "1px solid rgba(255,138,31,0.35)" : "1px solid #ef4444",
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="sm:col-span-2">
                    <label className={labelCls} style={{ color: "#ffd83a" }}>
                      {language === "af" ? "Vennoot / skool naam" : "Partner / school name"} <span style={{ color: "#ff6a1f" }}>*</span>
                    </label>
                    <input
                      className={fieldBase}
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#28c9d6" }}>{language === "af" ? "Verwysingskode" : "Referral code"}</label>
                    <input
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#ffd83a" }}>{language === "af" ? "Kommissie %" : "Commission %"}</label>
                    <div className="relative">
                      ...
                      />
                      <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-sm font-black" style={{ color: "#ffd83a" }}>%</span>
                    </div>
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#8e7cdc" }}>{language === "af" ? "Kontak naam" : "Contact name"}</label>
                    <input
                      className={fieldBase}
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#8e7cdc" }}>{language === "af" ? "Kontak e-pos" : "Contact email"}</label>
                    <input
                      type="email"
                      inputMode="email"
                      autoComplete="email"
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#28c9d6" }}>{language === "af" ? "Kontak telefoon" : "Contact phone"}</label>
                    <input
                      className={fieldBase}
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#b066d6" }}>{language === "af" ? "Provinsie" : "Province"}</label>
                    <select
                      className={fieldBase}
                      style={fieldStyle(true)}
                  ...
                  <div>
                    <label className={labelCls} style={{ color: "#b066d6" }}>{language === "af" ? "Distrik" : "District"}</label>
                    <input
                      className={fieldBase}
                      style={fieldStyle(true)}
                  ...
                  <div className="sm:col-span-2">
                    <label className={labelCls} style={{ color: "#e6519c" }}>{language === "af" ? "Notas" : "Notes"}</label>
                    <Textarea
                      ...
                      style={{ border: "1px solid rgba(230,81,156,0.35)", boxShadow: "inset 0 0 8px rgba(0,0,0,0.5)" }}
                    />
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{ border: "1px solid rgba(40,201,214,0.35)" }}
                >
                  <Sparkles className="w-3.5 h-3.5 mt-0.5 shrink-0" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 3px #28c9d6)" }} />
                ...
                <div className="flex justify-end gap-2 pt-1">
                  ...
                  <button
                    ...
                    style={{ color: "#ff8a1f", border: "1.5px solid #ff8a1f", boxShadow: "0 0 18px rgba(255,138,31,0.5), inset 0 0 8px rgba(255,138,31,0.18)" }}
                  >
      ...
      <Dialog open={showPartnerBulk} onOpenChange={setShowPartnerBulk}>
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Handshake className="w-4 h-4" style={{ color: "#ff8a1f", filter: "drop-shadow(0 0 6px #ff8a1f)" }} /> {language === "af" ? "Massa-invoer Vennote" : "Bulk Import Partners"}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div className="text-xs text-white space-y-1.5 p-3 rounded-lg bg-muted/40 border border-border">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="rounded-2xl">
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center gap-2">
                <School className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} />
        ...
        <CardContent className="space-y-4">
                ...
                <div key={c.cohortKey} className="flex flex-col sm:flex-row sm:items-center gap-3 rounded-xl border border-border/60 p-4 bg-muted/10">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <Button
                      ...
                      className={`h-8 text-xs gap-1.5 ${c.enabled ? "bg-[#28c9d6] hover:bg-[#28c9d6]/90 text-black border-0" : "border-border/60"}`}
          ...
          {runResult && (
            <div className="rounded-xl border border-border/60 bg-muted/10 p-4 text-xs space-y-1">
              ...
              <p>{language === "af" ? "Kennisgewings gestuur" : "Notifications sent"}: <span className="font-mono font-bold text-[#28c9d6]">{runResult.notificationsSent}</span></p>
                ...
                <TableBody>
                  {log.slice(0, 50).map(entry => (
                    <TableRow key={entry.id} className="hover:bg-white/[0.04] even:bg-white/[0.02]">
                      ...
                      <TableCell className="text-center">
                        <Badge variant="outline" className={`text-[10px] ${entry.milestoneDay <= 7 ? "border-[#e6519c]/50 text-[#e6519c]" : entry.milestoneDay <= 14 ? "border-[#ffd83a]/50 text-[#ffd83a]" : "border-[#28c9d6]/50 text-[#28c9d6]"}`}>
...
const REMINDER_TEMPLATES: ReminderTemplate[] = [
  {
    ...
    tone: "border-[#ffd83a]/40 bg-[#ffd83a]/10 text-[#ffd83a]",
  },
  {
    id: "study-streak",
    ...
    tone: "border-[#ff8a1f]/40 bg-[#ff8a1f]/10 text-[#ff8a1f]",
  },
  {
    id: "pep-talk",
    ...
    tone: "border-[#e6519c]/40 bg-[#e6519c]/10 text-[#e6519c]",
  },
  {
    id: "weekly-plan",
    ...
    tone: "border-[#4f8cd9]/40 bg-[#4f8cd9]/10 text-[#4f8cd9]",
  },
  {
    id: "trial-ending",
    ...
    tone: "border-[#8e7cdc]/40 bg-[#8e7cdc]/10 text-[#b066d6]",
  },
  {
    id: "new-papers",
    ...
    tone: "border-[#28c9d6]/40 bg-[#28c9d6]/10 text-[#28c9d6]",
  },
  {
    id: "holiday-close",
    ...
    tone: "border-[#ff6a1f]/40 bg-[#ff6a1f]/10 text-[#ff6a1f]",
  },
  {
    ...
    tone: "border-[#ffb020]/40 bg-[#ffb020]/10 text-[#ffb020]",
  },
];
...
function CustomReminderCard() {
  ...
  return (
    <Card className="bg-black border-white/15 rounded-2xl">
      <CardHeader className="pb-3">
        <CardTitle className="text-sm flex items-center gap-2">
          <Bell className="w-4 h-4 text-[#b066d6]" />
      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap gap-1.5">
            {REMINDER_TEMPLATES.map(t => (
              <button
                ...
                className={`text-[11px] px-2.5 py-1 rounded-full border transition ${activeTemplate === t.id ? "ring-2 ring-offset-2 ring-offset-background ring-[#b066d6] " : ""}${t.tone} hover:opacity-80`}
        ...
        <div className="flex items-center justify-between pt-1">
          ...
          <Button
            ...
            className="bg-[#b066d6] hover:bg-[#b066d6]/90 text-white border-0"
          >
        ...
        {result && (
          <div className="grid grid-cols-4 gap-2 text-center text-xs border-t border-border pt-3">
            ...
            <div className="rounded-lg border border-[#28c9d6]/40 bg-[#28c9d6]/10 p-2">
              <p className="text-lg font-bold tabular-nums text-[#28c9d6]">{result.pushSent}</p>
              <p className="text-[10px] text-white uppercase">{language === "af" ? "Stoot gestuur" : "Push sent"}</p>
            </div>
            <div className="rounded-lg border border-[#4f8cd9]/40 bg-[#4f8cd9]/10 p-2">
              <p className="text-lg font-bold tabular-nums text-[#4f8cd9]">{result.emailIntentLogged}</p>
              <p className="text-[10px] text-white uppercase">{language === "af" ? "E-pos-bedoeling" : "Email-intent"}</p>
            </div>
            <div className="rounded-lg border border-[#e6519c]/40 bg-[#e6519c]/10 p-2">
              <p className="text-lg font-bold tabular-nums text-[#e6519c]">{result.pushFailed}</p>
              <p className="text-[10px] text-white uppercase">{language === "af" ? "Misluk" : "Failed"}</p>
            </div>
          </div>
        )}
...
function ParentRatePromptCard() {
  ...
  return (
    <Card
      ...
      style={{ border: "1.5px solid #ffd83a", boxShadow: "0 0 0 1px rgba(255,216,58,0.25), 0 0 28px rgba(255,216,58,0.25)" }}
    >
      <CardHeader className="pb-3">
        <CardTitle className="text-sm flex items-center gap-2">
          <span
            className="inline-flex items-center justify-center w-7 h-7 rounded-lg bg-black"
            style={{ border: "1.5px solid #ffd83a", boxShadow: "0 0 10px rgba(255,216,58,0.5)" }}
          >
            <Star className="w-3.5 h-3.5" style={{ color: "#ffd83a", filter: "drop-shadow(0 0 4px #ffd83a)" }} />
          </span>
          <span
            style={{
              background: "linear-gradient(90deg, #ffd83a, #ff8a1f, #e6519c)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
            }}
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <label className="text-[10px] font-black uppercase tracking-[0.18em] mb-1.5 block" style={{ color: "#ffd83a" }}>{language === "af" ? "Titel (EN)" : "Title (EN)"}</label>
            <input
              className="w-full text-sm rounded-lg px-3 py-2 bg-black text-white placeholder:text-white focus:outline-none"
              style={{ border: "1px solid rgba(255,216,58,0.35)" }}
              value={titleEn}
          ...
          <div>
            <label className="text-[10px] font-black uppercase tracking-[0.18em] mb-1.5 block" style={{ color: "#ff8a1f" }}>{language === "af" ? "Titel (AF)" : "Title (AF)"}</label>
            <input
              className="w-full text-sm rounded-lg px-3 py-2 bg-black text-white placeholder:text-white focus:outline-none"
              style={{ border: "1px solid rgba(255,138,31,0.35)" }}
              value={titleAf}
          ...
          <div>
            <label className="text-[10px] font-black uppercase tracking-[0.18em] mb-1.5 block" style={{ color: "#28c9d6" }}>{language === "af" ? "Boodskap (EN)" : "Message (EN)"}</label>
            <Textarea
              value={messageEn}
          ...
          <div>
            <label className="text-[10px] font-black uppercase tracking-[0.18em] mb-1.5 block" style={{ color: "#8e7cdc" }}>{language === "af" ? "Boodskap (AF)" : "Message (AF)"}</label>
            <Textarea
              value={messageAf}
              onChange={e => setMessageAf(e.target.value)}
              className="text-sm min-h-[80px] bg-black text-white"
              style={{ border: "1px solid rgba(142,124,220,0.35)" }}
              maxLength={400}
            />
          </div>
          <div className="md:col-span-2">
            <label className="text-[10px] font-black uppercase tracking-[0.18em] mb-1.5 block" style={{ color: "#e6519c" }}>{language === "af" ? "Graderings-URL (CTA)" : "Rate URL (CTA)"}</label>
            <input
              className="w-full text-sm rounded-lg px-3 py-2 bg-black text-white placeholder:text-white focus:outline-none font-mono"
              style={{ border: "1px solid rgba(230,81,156,0.35)" }}
              value={ctaUrl}
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            onClick={() => send.mutate()}
            className="inline-flex items-center gap-2 rounded-lg bg-black px-4 py-2 text-xs font-black uppercase tracking-[0.18em] transition-none disabled:opacity-40"
            style={{ color: "#ffd83a", border: "1.5px solid #ffd83a", boxShadow: "0 0 18px rgba(255,216,58,0.45), inset 0 0 8px rgba(255,216,58,0.15)" }}
          >
        ...
        {result && (
          <div className="grid grid-cols-4 gap-2 text-center text-xs border-t border-white/10 pt-3">
            ...
            <div className="rounded-lg border border-[#ffd83a]/40 bg-[#ffd83a]/10 p-2">
              <p className="text-lg font-bold tabular-nums text-[#ffd83a]">{result.inAppCreated}</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-black border-white/15 rounded-2xl">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            <TrendingUp className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} />
            {trendLabels.title}
          </CardTitle>
        </CardHeader>
          ...
          {trendLoading ? (
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={trendPoints} margin={{ top: 4, right: 8, left: -20, bottom: 0 }} barCategoryGap="30%">
                ...
                <Bar dataKey="learnersReached" name={trendLabels.learnersReached} fill="#28c9d6" radius={[3, 3, 0, 0]} />
      ...
      <Card className="bg-black border-white/15 rounded-2xl">
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <CardTitle className="text-sm flex items-center gap-2">
                <Send className="w-4 h-4" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} />
                {t.title}
              </CardTitle>
                  ...
                  <TableBody>
                    {visibleRows.map((row, i) => (
                      <TableRow key={`${row.user_id}-${i}`} className="border-white/5 hover:bg-white/[0.03]">
                        ...
                        <TableCell className="py-2">
                          <span className="text-[11px] text-muted-foreground font-mono">{row.payload_tag ?? "—"}</span>
                        </TableCell>
                        <TableCell className="py-2">
                          {row.success ? (
