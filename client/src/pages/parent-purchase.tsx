...
export default function ParentPurchasePage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 py-16 bg-background overflow-hidden">
      ...
      >
        <div className="absolute -top-3 right-4 px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-[0.15em] bg-gradient-to-r from-[#FF8A00] to-[#FF2BD6] text-white border border-[#FFE600] shadow-lg">
          ⭐ Early Tester
        </div>
