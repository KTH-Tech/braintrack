...
function NeonShell({ children, color = "#C6A4FF", className = "" }: { children: React.ReactNode; color?: string; className?: string }) {
  return (
    <div
      ...
      style={{ border: `1.5px solid ${color}`, boxShadow: `0 0 0 1px rgba(198,164,255,0.22), 0 0 28px rgba(198,164,255,0.18)` }}
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <NeonShell color="#C6A4FF">
                <div className="p-6 space-y-6">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-black flex items-center justify-center" style={{ border: "1.5px solid #C6A4FF", boxShadow: "0 0 12px rgba(198,164,255,0.4)" }}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{ border: "1px solid rgba(198,164,255,0.4)" }}
                    />
                  ...
                  <div>
                    ...
                    {hasAnyLogo ? (
                      <div className="flex flex-col gap-3">
                        <div className="relative rounded-xl overflow-hidden bg-white flex items-center justify-center" style={{ height: 80, border: "1px solid rgba(198,164,255,0.3)" }}>
                        ...
                        <div className="flex gap-2">
                          <button type="button" onClick={() => fileInputRef.current?.click()} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-bold transition" style={{ border: "1px solid rgba(198,164,255,0.5)", color: "#C6A4FF" }} data-testid="btn-replace-logo">
                            <Upload className="w-3.5 h-3.5" />
                            {isAf ? "Vervang" : "Replace"}
                          </button>
                          <button type="button" onClick={handleClearLogo} className="flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-bold transition" style={{ border: "1px solid rgba(255,159,229,0.5)", color: "#FF9FE5" }} data-testid="btn-clear-logo">
                      ...
                      <button type="button" onClick={() => fileInputRef.current?.click()} className="w-full flex flex-col items-center justify-center gap-2 rounded-xl py-6 text-sm font-semibold transition-all hover:bg-white/5" style={{ border: "2px dashed rgba(198,164,255,0.4)", color: "#C6A4FF" }} data-testid="btn-upload-logo">
                  ...
                  <button
                    ...
                    style={{ background: "#C6A4FF", color: "#000", boxShadow: "0 0 20px rgba(198,164,255,0.5)" }}
                  >
              ...
              <NeonShell color="#7FEFFF">
                <div className="p-6 space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-black flex items-center justify-center" style={{ border: "1.5px solid #7FEFFF", boxShadow: "0 0 12px rgba(127,239,255,0.4)" }}>
                  ...
                  <div className="rounded-xl p-4 space-y-2" style={{ background: "rgba(127,239,255,0.06)", border: "1px solid rgba(127,239,255,0.18)" }}>
