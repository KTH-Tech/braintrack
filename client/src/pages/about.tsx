...
const aboutBreadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "About", "item": "https://braintrack.app/about" },
  ],
};
...
export default function AboutPage() {
  ...
  useSEO({
    ...
    canonical: "https://braintrack.app/about",
    ...
    ogUrl: "https://braintrack.app/about",
      ...
      <main className="relative pt-14 pb-16">
        ...
        <section className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            <p className="text-[11px] font-black uppercase tracking-[0.2em] mb-3" style={{ color: "#28c9d6", textShadow: "0 0 8px rgba(40,201,214,0.5)" }} data-testid="text-about-tagline">
              {c.tagline}
            </p>
