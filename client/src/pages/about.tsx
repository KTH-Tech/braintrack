    ...
    <div className="min-h-screen" style={{ background: "#000", color: "#fff" }} data-testid="page-about">
      ...
      <main style={{ paddingTop: 64, overflowX: "hidden" }}>
        <style>{`
          ...
          /* Narrow phones: let the CTA label wrap instead of clipping past
             the viewport edge (English "Start Learning Smarter" + arrow). */
          @media (max-width: 400px) {
            .bta-cta { white-space: normal !important; }
          }
        `}</style>
