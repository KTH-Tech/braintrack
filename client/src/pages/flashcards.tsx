    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 space-y-6">
        <div
          ...
          style={{ border: "1.5px solid #28c9d6", boxShadow: "0 0 0 1px rgba(40,201,214,0.25), 0 0 28px rgba(40,201,214,0.55), inset 0 0 18px rgba(0,0,0,0.6)" }}
        >
          <Trophy className="w-10 h-10" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px #28c9d6)" }} />
        </div>
            ...
            {subjects.length === 0 ? (
              ...
              return (
                <button
                  ...
                  style={{
                    background: pct > 0 ? "rgba(40,201,214,0.06)" : "rgba(255,255,255,0.04)",
                    borderColor: pct > 0 ? "rgba(40,201,214,0.35)" : "rgba(255,255,255,0.10)",
                  }}
                >
                  <div className="flex items-center justify-between gap-3 mb-2">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span className="text-xs font-black" style={{ color: pct > 0 ? "#28c9d6" : "rgba(255,255,255,0.3)" }}>
                        {pct}%
                      </span>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: pct >= 80
                          ...
                          : pct >= 40
                            ? "linear-gradient(90deg,#28c9d6,#8e7cdc)"
                            : "linear-gradient(90deg,#4f8cd9,#28c9d6)",
                      }}
                    />
                  </div>
                </button>
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="rounded-xl border p-4 space-y-2.5"
          style={{ background: "rgba(40,201,214,0.06)", borderColor: "rgba(40,201,214,0.3)" }}>
          <div className="flex items-center justify-between">
            <h2 className="text-base font-black text-white">{selectedSubjectName}</h2>
            <span className="text-xs font-black" style={{ color: "#28c9d6" }}>
          ...
          <div className="h-2 rounded-full bg-white/10 overflow-hidden">
            <div
              className="h-full rounded-full transition-all duration-500"
              style={{ width: `${subjectPct}%`, background: "linear-gradient(90deg,#28c9d6,#8e7cdc)" }}
            />
          </div>
            ...
            {dbDeck.topics.map(t => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: pct === 100 ? "rgba(16,185,129,0.07)" : pct > 0 ? "rgba(40,201,214,0.05)" : "rgba(255,255,255,0.03)",
                    borderColor: pct === 100 ? "rgba(16,185,129,0.4)" : pct > 0 ? "rgba(40,201,214,0.25)" : "rgba(255,255,255,0.08)",
                  }}
                >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {t.hasNotes && (
                        <span className="text-[9px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded mt-0.5 inline-block"
                          style={{ color: "#28c9d6", border: "1px solid rgba(40,201,214,0.4)", background: "rgba(40,201,214,0.08)" }}>
                  ...
                  <div className="h-1 rounded-full bg-white/10 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${pct}%`,
                        background: pct === 100 ? "linear-gradient(90deg,#10b981,#34d399)" : "linear-gradient(90deg,#28c9d6,#8e7cdc)",
                      }}
                    />
                  </div>
                </button>
