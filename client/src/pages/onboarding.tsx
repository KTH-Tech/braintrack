...
const T = {
  en: {
    ...
    consentNotConfiguredDesc: "Ask your parent to visit braintrack.app/parent to register.",
    consentFailed: "Could not send link",
    consentFailedDesc: "Please ask your parent to register directly at braintrack.app/parent.",
  ...
  af: {
    ...
    consentNotConfiguredDesc: "Vra jou ouer om by braintrack.app/parent te registreer.",
    consentFailed: "Kon nie skakel stuur nie",
    consentFailedDesc: "Vra jou ouer asseblief om direk by braintrack.app/parent te registreer.",
