    ...
    <div className="dark relative min-h-screen bg-background text-white overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <Link href="/">
              <button
                ...
                style={{ color: "#7FEFFF", border: "1.5px solid #7FEFFF", boxShadow: "0 0 10px rgba(127,239,255,0.3)" }}
            ...
            <span className="graffiti-hand text-base hidden sm:inline tracking-tight" style={{ color: "#FFF29E", textShadow: "0 0 8px rgba(255,242,158,0.4)" }}>{isAf ? "Privaatheidsbeleid" : "Privacy Policy"}</span>
          </div>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 py-10 space-y-12">
        <div className="relative text-center space-y-3 py-6">
          ...
          >
            <Shield className="w-6 h-6" style={{ color: "#7FEFFF", filter: "drop-shadow(0 0 6px rgba(127,239,255,0.7))" }} />
          </div>
          <h1 className="graffiti-hand text-3xl" style={{ textShadow: "0 0 10px rgba(127,239,255,0.4)" }}>{isAf ? "Privaatheidsbeleid & POPIA-Nakoming" : "Privacy Policy & POPIA Compliance"}</h1>
