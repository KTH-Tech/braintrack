...
export default function CookiePolicyPage() {
  ...
  useSEO({
    ...
    canonical: "https://braintrack.app/cookie-policy",
  });
    ...
    <div className="dark min-h-screen bg-black text-white">
      ...
      <main className="relative max-w-4xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="relative text-center space-y-3 py-6">
          ...
          >
            <Cookie className="w-6 h-6" style={{ color: "#28c9d6", filter: "drop-shadow(0 0 6px rgba(40,201,214,0.7))" }} />
          </div>
          <h1 className="text-2xl font-black text-white" style={{ textShadow: "0 0 10px rgba(40,201,214,0.4)" }}>
            {isAf ? "Koekiebeleid" : "Cookie Policy"}
          </h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm text-white">
            ...
            <p className="text-xs">
              ...
              <strong className="text-white">brain-support@kthtech.co.za</strong>
              {isAf
