    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-4 py-6">
        <Tabs defaultValue="plans">
          <TabsList className="mb-6 p-1.5 rounded-2xl h-auto flex-wrap bg-black border border-[#00E5FF]/30 shadow-[0_0_14px_rgba(0,229,255,0.18)]">
            <TabsTrigger value="plans" className="rounded-xl gap-2 text-xs px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#00E5FF] data-[state=active]:border data-[state=active]:border-[#00E5FF] data-[state=active]:shadow-[0_0_14px_rgba(0,229,255,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors"><CreditCard className="w-3.5 h-3.5" />{tr.plansTab} ({plans.length})</TabsTrigger>
            <TabsTrigger value="products" className="rounded-xl gap-2 text-xs px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#00E5FF] data-[state=active]:border data-[state=active]:border-[#00E5FF] data-[state=active]:shadow-[0_0_14px_rgba(0,229,255,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors"><ShoppingBag className="w-3.5 h-3.5" />{tr.productsTab} ({products.length})</TabsTrigger>
            <TabsTrigger value="settings" className="rounded-xl gap-2 text-xs px-4 py-2 data-[state=active]:bg-black data-[state=active]:text-[#00E5FF] data-[state=active]:border data-[state=active]:border-[#00E5FF] data-[state=active]:shadow-[0_0_14px_rgba(0,229,255,0.45)] data-[state=active]:font-black text-white hover:text-white transition-colors"><Settings className="w-3.5 h-3.5" />{tr.settingsTab}</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="products">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                style={{ background: "linear-gradient(90deg,#00E5FF,#006BFF)", color: "#000", boxShadow: "0 0 18px rgba(0,229,255,0.5)" }}
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="max-w-lg rounded-2xl bg-black border border-[#00E5FF]/40 shadow-[0_0_40px_rgba(0,229,255,0.25)] p-0 overflow-hidden">
          <div className="h-[3px] w-full" style={{ background: "linear-gradient(90deg,#00E5FF,#006BFF,#8A2BFF,#FF2BD6)" }} />
          <div className="p-6">
            <DialogHeader className="mb-5">
              <DialogTitle className="text-lg font-black text-white flex items-center gap-2">
                <PlusCircle className="w-5 h-5" style={{ color: "#00E5FF" }} />
            ...
            <div className="flex justify-end gap-3 mt-6 pt-5 border-t border-white/10">
              ...
              <button
                ...
                style={{ background: "linear-gradient(90deg,#00E5FF,#006BFF)", color: "#000", boxShadow: "0 0 18px rgba(0,229,255,0.45)" }}
              >
                <PlusCircle className="w-3.5 h-3.5" />
