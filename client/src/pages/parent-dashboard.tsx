...
const PARENT_FAQ = {
  en: [
    ...
    { q: "How do I contact support?", a: "Email brain-support@kthtech.co.za or use the help button in the app. We respond within 24 hours." },
  ],
  af: [
    ...
    { q: "Hoe kontak ek ondersteuning?", a: "Stuur 'n e-pos aan brain-support@kthtech.co.za of gebruik die hulpknoppie in die app." },
  ],
};
