...
const T = {
  en: {
    ...
    referAFriendSubtitle: "Every 2 friends who become paying members earns you 1 month free",
    ...
    referralDisclaimer: "Your friends must activate and pay for their own subscription. Free months are added to your subscription once 2 friends have paid, and only while your own subscription is active.",
  ...
  af: {
    ...
    referAFriendSubtitle: "Elke 2 vriende wat betalende lede word, gee jou 1 maand gratis",
    ...
    slotsLeft: "Slots oor",
    referralDisclaimer: "Jou vriende moet hul eie intekening aktiveer en betaal. Gratis maande word by jou intekening gevoeg sodra 2 vriende betaal het, en slegs terwyl jou eie intekening aktief is.",
