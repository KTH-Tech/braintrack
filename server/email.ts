    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" role="presentation"
          ...
          <!-- Header / logo area -->
          <tr>
            <td align="center" style="padding:36px 40px 20px;background:#ffffff;">
              <!-- Brain emoji icon -->
              <div style="font-size:52px;line-height:1;margin-bottom:10px;">&#129504;</div>
              <!-- BrainTrack™ rainbow letter-by-letter -->
              <div style="font-family:Arial,Helvetica,sans-serif;font-size:34px;font-weight:900;letter-spacing:-1px;line-height:1;">
                <span style="color:#e53935;">B</span><span style="color:#e67e22;">r</span><span style="color:#f1c40f;">a</span><span style="color:#27ae60;">i</span><span style="color:#2980b9;">n</span><span style="color:#8e44ad;">T</span><span style="color:#e91e63;">r</span><span style="color:#e53935;">a</span><span style="color:#e67e22;">c</span><span style="color:#f1c40f;">k</span><span style="color:#aaa;font-size:20px;vertical-align:super;">&#8482;</span>
              </div>
              <!-- Tagline -->
              <div style="font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:600;
                          color:#555555;margin-top:6px;letter-spacing:0.3px;">
                Powered by <strong style="color:#7c3aed;">KTH Tech</strong>
              </div>
            </td>
          </tr>
